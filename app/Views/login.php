        ...
        <div class="container-login100">
            <div class="wrap-login100 shadow">
                ...
                <form class="login100-form">
                    <a href="<?= $googleButton; ?>" class="btn-google m-b-20">

                        <svg style="height: 32px;" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48" style=" fill:#000000;">
